...
* **Fix for [CVE-2024-39397](https://nvd.nist.gov/vuln/detail/CVE-2024-39397)**—Resolves a remote code execution security vulnerability in custom product options through file uploads and `POST` operations on the `/checkout/cart/updateItemOptions/id/{id}` REST API endpoint. This vulnerability affects merchants using the Apache web server for on-premises or self-hosted deployments. This fix is also available as an isolated patch. See the [TBD - MSKB-2658](https://experienceleague.adobe.com/en/docs/commerce-knowledge-base/kb/overview) Knowledge Base article for details.<!-- ACSD-60551 -->
