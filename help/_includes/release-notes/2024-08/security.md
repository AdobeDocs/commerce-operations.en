...
* **Encryption key rotation**—All values in the `core_config_data` database table are now re-encrypted with a new key during an [encryption key rotation process](https://experienceleague.adobe.com/en/docs/commerce-admin/systems/security/encryption-key). Previously, some values were left encrypted with the old key.<!-- AC-12526, AC-12527, AC-12528, AC-12529 -->
