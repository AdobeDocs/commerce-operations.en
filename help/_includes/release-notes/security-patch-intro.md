...
* Instructions for downloading and applying security patch releases are available in the [How to obtain and apply security patches](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-commerce-support/how-to-obtain-and-apply-security-patches) in the _Adobe Commerce Knowledgebase_.
