...
The following reference documentation is generated from the `composer.lock` file, and it covers required packages included in Magento Open Source 2.4.6.

## Dependencies

`magento/product-community-edition 2.4.6` has the following dependencies:
