...
We have fixed 231 issues in the Magento Open Source 2.4.8 core code. A subset of the fixed issues included in this release is described below.
...
* _AC-11673_: 
  ...
  * _GitHub code contribution_: Make sure latest version of php-amqplib/php-amqplib latest versions should be compatible
...
* _AC-12022_: 
  ...
  * _GitHub code contribution_: The system has been updated to use the latest major version of the "monolog/monolog" library, ensuring compatibility and improved performance. Previously, the system was using an outdated version of the "monolog/monolog" library which could have led to potential issues and limitations.
* _AC-12023_: 
...
* _AC-12024_: 
  ...
  * _GitHub issue_: <<https://github.com/magento/magento2/commit/de4dfb8e>>
  * _GitHub code contribution_: Upgrade jquery/validate library dependency to the latest minor version
* _AC-12025_: 
  * _Fix note_: Upgrade moment.js system dependency to the latest minor version
  * _GitHub issue_: <<https://github.com/magento/magento2/commit/de4dfb8e>>
  * _GitHub code contribution_: Upgrade moment.js system dependency to the latest minor version
* _AC-12267_: 
  ...
  * _GitHub issue_: <<https://github.com/magento/magento2/commit/672a2e61>>
  * _GitHub code contribution_: Make sure latest version of colinmollenhour/php-redis-session-abstract v2.0.0 compatible with adobe commerce
...
* _AC-8714_: 
  * _Fix note_: Varnish 7.3 - Sub Categories links / options of Default category are not getting displayed on Store front Home page
  * _GitHub issue_: <<https://github.com/magento/magento2/commit/d1c335aa>, <https://github.com/magento/magento2/ (Internal, Unmerged)>>
  * _GitHub code contribution_: Storefront home pages now display default category subcategories as expected. Previously, shoppers could access subcategories by URL only.
...
* _AC-9712_: https://github.com/magento/magento2/issues/37841
  ...
  * _GitHub issue_: <<https://github.com/magento/magento2/ (Internal, Unmerged)>>
  * _GitHub code contribution_: Fix the difference in less compilation between php & nodejs library (grunt)
...
* _AC-12128_: 
  * _Fix note_: [Cloud] Prototype.js security vulnerability CVE-2020-27511
  * _GitHub issue_: <<https://github.com/magento/magento2/commit/de4dfb8e>>
  * _GitHub code contribution_: Security vulnerability CVE-2020-27511 should be resolved
...
* _AC-12950_: Update tinymce 7.3.0 in composer.json and Remove from files from tinymce 7
  * _Fix note_: Make TinyMCE 7.x to be a supported version for Adobe Commerce 2.4.8-beta1
  * _GitHub code contribution_: <https://github.com/magento/magento2/ (Internal, Unmerged)>
