...
We have fixed 209 issues in the Magento Open Source 2.4.8 core code. A subset of the fixed issues included in this release is described below.
...
* _ACP2E-3154_: Prototype.js Array.from in conflict with Google Maps API
  ...
  * _GitHub code contribution_: <https://github.com/magento/magento2/commit/>
...
* _AC-8714_: Varnish 7.3 - Sub Categories links / options of Default category are not getting displayed on Store front Home page
  ...
  * _GitHub code contribution_: <https://github.com/magento/magento2/commit/d1c335aa>, <https://github.com/magento/magento2/commit/>
