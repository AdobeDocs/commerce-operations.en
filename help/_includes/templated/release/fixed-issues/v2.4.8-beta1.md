...
We have fixed 279 issues in the Adobe Commerce 2.4.8 core code. A subset of the fixed issues included in this release is described below.
...
* _AC-12268_: 
  * _Fix note_: Investigate the performance issue after upgrade league/flysystem Composer dependencies to latest version
...
* _AC-12715_: 
  * _Fix note_: Investigate the laminas composer dependencies upgrading to latest version
