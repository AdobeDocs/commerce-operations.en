...
We have fixed 242 issues in the Adobe Commerce 2.4.8 core code. A subset of the fixed issues included in this release is described below.
...
* _AC-12166_: MFTF tests crash in Chrome on print order pages
  * _Fix note_: MFTF tests for print order pages now run as expected on Chrome.
