...
- Best practices {#best-practices}
  ...
  - Planning {#planning}
    ...
    - [Sites, stores, and store view configuration](sites-stores-views.md)
    ...
    - [Pagination configuration for product listings](best-practices/planning/paginating-product-listings.md)
