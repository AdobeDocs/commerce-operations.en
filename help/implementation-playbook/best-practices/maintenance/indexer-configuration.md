...
# Configuration best practices for indexers

To maintain and optimize site performance, review and update the indexer configuration using the performance best practices described in this article.
...
- [!UICONTROL Update on Schedule] mode stores information about data updates, and reindexing operations are managed by a cron job that updates index data in the background at scheduled intervals.
