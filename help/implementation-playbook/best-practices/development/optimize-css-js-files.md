...
Do not merge or bundle files if your deployment uses HTTP2. HTTP2 downloads static files asynchronously. Browsers must download an entire merged file before processing the file contents.
