---
title: Data Migration Tool prerequisites
description: Learn what you need to do before you start using the Data Migration Tool to transfer data between Magento 1 and Magento 2.
---

# Data Migration Tool prerequisites
