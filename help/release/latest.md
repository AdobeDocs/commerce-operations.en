...
- **Thursday March 14**: Join Adobe Commerce product leadership teams live for an Adobe Commerce Roadmap Webinar on Thursday March 14, 2024. Register for the live webinar here.
...
Later this year, we will also be releasing pre-built integrations for two common ERPs using the integration starter kit:
