...
<tfoot>
   <tr>
      <td colspan="3"><strong>Legend</strong>
         <ul>
           <li><strong><img alt="B2B feature icon" src="../assets/icons/enterprise.svg"></img> B2B</strong>—New features, enhancements, and bug fixes for the B2B extension for Adobe Commerce. For details about B2B releases, see the [B2B Release Notes](https://experienceleague.adobe.com/en/docs/commerce-admin/b2b/release-notes).</li>
