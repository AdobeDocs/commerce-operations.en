...
*  The ability to configure an installation to use a split database has been deprecated in this release. See [Revert from a split database to a single database](../../../configuration/storage/revert-split-database.md) for migration instructions.
