...
This release includes 19 security fixes and platform security improvements.
...
**PHP 8.3 compatibility**. This release introduces support for PHP 8.3. Magento Open Source 2.4.7-beta3 now supports both PHP 8.3 and 8.2. PHP 8.2 will be supported until its End of Service (EOS) date in December 2025. After December 2025, all merchants running 2.4.7 deployments should migrate to PHP 8.3. <!-- AC-8988 -->
...
The following known issue will be fixed in Magento Open Source 2.4.7 GA:
