---
title: Magento Open Source 2.4.7-beta3 release notes
description: Learn about new features, enhancements, bug fixes and known issues in the 2.4.7-beta3 Magento Open Source release.
badgeCoreBeta: label="2.4.7-beta" type="informative"
exl-id: 0145380a-8b4b-4757-a5fe-d98713f0df62
---

# Magento Open Source 2.4.7-beta3 release notes
...
Magento Open Source 2.4.7-beta3 introduces support for PHP 8.3. It includes over 150 quality fixes and enhancements. Core Composer dependencies and third-party libraries have been upgraded to the latest available versions.
...
Magento Open Source 2.4.7-beta3 has been tested against the following component versions:
...
## Magento Open Source 2.4.7-beta3 highlights

Look for the following highlights in this release.

### Security enhancements

This release includes the same security fixes and platform security improvements that are included in Adobe Commerce 2.4.6-p5, 2.4.5-p7, and 2.4.4-p8. See [Adobe Security Bulletin](https://helpx.adobe.com/security/products/magento/apsb24-03.html) for the latest discussion of these fixed issues.
...
Magento Open Source 2.4.7-beta3 includes the following platform upgrades:
...
Magento Open Source 2.4.7-beta3 is still compatible with PHP 8.1 for upgrade purposes only. PHP 8.1 is not supported and not recommended. Magento Open Source 2.4.7-beta3 core code, all bundled extensions, and all Adobe-owned extensions and SaaS services are compatible with PHP 8.3. <!-- AC-9668 -->

* **RabbitMQ 3.11 support**. This release is compatible with the latest version of RabbitMQ 3.11. Compatibility remains with RabbitMQ 3.9, which is supported through August 2023, but we recommended using Magento Open Source 2.4.7-beta3 only with RabbitMQ 3.11.

* **Composer 2.6.x**. Compatibility with Composer 2.2.x remains. <!-- AC-9663 -->

* **Varnish cache 7.4 support**. This release is compatible with the latest version of Varnish Cache 7.4. Compatibility remains with the 6.0.x and 7.2.x versions, but we recommended using Magento Open Source 2.4.7-beta3 only with Varnish Cache version 7.4 or version 6.0 LTS. <!-- AC-9662 -->
...
Magento Open Source 2.4.7 includes enhanced GraphQL caching abilities, support to the GraphQL schema for custom attributes, support for headless order cancelation, and improved resolver cqching.
...
* Magento Open Source now displays bundle products as expected on the Catalog page when **[!UICONTROL Use Flat Catalog Product]** is set to **yes**. [GitHub-33935](https://github.com/magento/magento2/issues/33935)
...
* Shoppers can now edit the quantity of a bundle product in their storefront shopping cart. Previously, Magento Open Source did not handle null values for `ItemId` when products were edited in the storefront shopping cart and displayed this error: [GitHub-37696](https://github.com/magento/magento2/issues/37696)
...
* The REST `V1/products/<sku>/media` endpoint can now process the simultaneous upload of multiple media images. Previously, Previously, while processing several requests simultaneously, inconsistent data was created, and Magento Open Source threw an error when this data was saved into the database.
...
* Invisible reCAPTCHA v3 now works as expected for the checkout page Sign in button. Previously, shoppers could not login, and Magento Open Source threw JavaScript errors.
...
The following known issues will be fixed in Adobe Commerce 2.4.7 GA:

**Issue**: AWS Cloud native services are not compatible with PHP 8.3. Compatibility with PHP 8.3 will be introduced in Adobe Commerce 2.4.7 GA. <!-- AC-11395 -->

**Issue**: Categories are not visible to shoppers in stores where cache is set to Fastly CDN (**[!UICONTROL Caching Application=Fastly CDN]**). This affects both guest shoppers and registered customers.  <!-- AC-11411 -->
...
You can install Magento Open Source 2.4.7-beta3 using [Composer](https://experienceleague.adobe.com/docs/commerce-operations/installation-guide/composer.html).
