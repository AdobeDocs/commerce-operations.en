...
description: Learn about new features, enhancements, bug fixes and known issues in the 2.4.7-beta1 Magento Open Source release.
...
Adobe Open Source 2.4.7-beta2 introduces these platform upgrades:
...
You can install Magento Open Source 2.4.7-beta1 using [Composer](https://experienceleague.adobe.com/docs/commerce-operations/installation-guide/composer.html).
