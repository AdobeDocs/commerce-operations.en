...
* **New GraphQL resolver cache types** include: 
    * CMS page. This caches the results of the CMS Page resolver. <!-- B2B-2451 -->
    * CMS blocks. This caches the results returned from `Magento\CmsGraphQl\Model\Resolver\Blocks::resolve`. <!-- B2B-2659 -->
