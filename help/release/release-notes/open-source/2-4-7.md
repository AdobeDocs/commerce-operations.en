---
title: Magento Open Source 2.4.7-beta2 release notes
description: Learn about new features, enhancements, bug fixes and known issues in the 2.4.7-beta2 Magento Open Source release.
badgeCoreBeta: label="2.4.7-beta" type="informative"
exl-id: 0145380a-8b4b-4757-a5fe-d98713f0df62
---

# Magento Open Source 2.4.7-beta2 release notes
...
Magento Open Source 2.4.7-beta2 includes over 200 quality fixes and enhancements. Core Composer dependencies and third-party libraries have been upgraded to the latest available versions.
...
Magento Open Source 2.4.7-beta2 has been tested against the following component versions:
...
## Magento Open Source 2.4.7-beta2 highlights

Look for the following highlights in this release.

### Security enhancements

This release introduces ten security fixes and platform security improvements. Previous betas of Adobe Commerce 2.4.7 introduced 13 security fixes and platform security improvements.
...
Magento Open Source 2.4.7-beta1 introduced the following enhancement, which introduces a change in the default behavior of an existing REST endpoint:
...
Magento Open Source 2.4.7-beta2 introduces these platform upgrades:
...
* The `addProductsToCart` mutation now successfully adds a gift card to a cart. Previously, this query expected the gift card recipient name, but the sender name was instead returned. Magento Open Source threw this error: `Please specify a recipient name`. [GitHub-36665](https://github.com/magento/magento2/issues/36665)
...
The following known issues will be fixed in Magento Open Source 2.4.7-beta3:
...
You can install Magento Open Source 2.4.7-beta2 using [Composer](https://experienceleague.adobe.com/docs/commerce-operations/installation-guide/composer.html).
