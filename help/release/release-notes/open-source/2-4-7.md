...
* **[!DNL Vaulted PayPal] and [!DNL PayLater] Changes**—Logged-in customers who have previously vaulted/stored their PayPal account have the option to pay with:
  ...
  * [!DNL PayPal PayLater] or [!DNL PayPal Credit] button
...
* Customer segment banners now behave as expected when a shopper that is using a newly created customer account logs out. Previously, banners created for the logged-in customer segment were displayed even after that account session ended (that is, the registered shopper logged out). 
