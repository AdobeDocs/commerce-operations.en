...
Magento Open Source 2.4.7-beta3 includes over 200 quality fixes and enhancements. Core Composer dependencies and third-party libraries have been upgraded to the latest available versions.
...
Magento Open Source 2.4.7-beta3 is still compatible with PHP 8.1 for upgrade purposes only. PHP 8.1 is not supported and not recommended. Adobe Commerce 2.4.7-beta3 core code, all bundled extensions, and all Adobe-owned extensions and SaaS services are compatible with PHP 8.3. <!-- AC-9668 -->
...
Page Builder v.1.7.4 is compatible with Magento Open Source 2.4.7-beta3.
...
<!-- ACP2E-2034 -->
Magento Open Source now displays correct prices for fixed bundle products with special prices. This was a known issue for 2.4.7-beta1.
