...
GraphQL support has been addded for order cancelation. The `cancelOrder` mutation allows a customer to cancel an order, passing its identifier and a cancellation reason. <!-- LYNX-197 -->
