...
**Issue**: The product image link in the order confirmation, invoice, and credit memo emails, and Admin order details page
does not download the product image as expected. Instead, Adobe Commerce displays a blank screen when a shopper clicks the link for a configurable product image. <!-- AC-8849 -->
