...
*  **Wish lists**. The [addWishlistItemsToCart mutation](https://developer.adobe.com/commerce/webapi/graphql/schema/wishlist/mutations/add-items-to-cart/) moves items from the specified wish list to the customer's cart. <!-- magento/partners-magento2ee#449-->

*  **Gift registries**. Tasks covered include: <!-- PWA-1290-->

   *  Use the [giftRegistry query](https://developer.adobe.com/commerce/webapi/graphql/schema/gift-registry/queries/gift-registry/) to return the contents of the customer's gift registries.

   *  Search for gift registries by [type](https://developer.adobe.com/commerce/webapi/graphql/schema/gift-registry/queries/type-search/), [email](https://developer.adobe.com/commerce/webapi/graphql/schema/gift-registry/queries/email-search/), or [ID](https://developer.adobe.com/commerce/webapi/graphql/schema/gift-registry/queries/id-search/).

   *  [Create](https://developer.adobe.com/commerce/webapi/graphql/schema/gift-registry/mutations/create/), [update](https://developer.adobe.com/commerce/webapi/graphql/schema/gift-registry/mutations/update/), or [delete](https://developer.adobe.com/commerce/webapi/graphql/schema/gift-registry/mutations/remove/) gift registries.

   *  [Update](https://developer.adobe.com/commerce/webapi/graphql/schema/gift-registry/mutations/update-items/) or [remove](https://developer.adobe.com/commerce/webapi/graphql/schema/gift-registry/mutations/remove-items/) items from a gift registry.

   *  [Move all items](https://developer.adobe.com/commerce/webapi/graphql/schema/gift-registry/mutations/move-cart-items/) from the cart to the gift registry. <!-- ENGCOM-9082 9087-->

   *  [Add](https://developer.adobe.com/commerce/webapi/graphql/schema/gift-registry/mutations/add-registrants/), [update](https://developer.adobe.com/commerce/webapi/graphql/schema/gift-registry/mutations/update-registrants/), or [remove](https://developer.adobe.com/commerce/webapi/graphql/schema/gift-registry/mutations/remove-registrants/) registrants from a gift registry.

   *  [Share](https://developer.adobe.com/commerce/webapi/graphql/schema/gift-registry/mutations/share/) a gift registry with invitees.

*  **Negotiable quotes**. See the [`negotiableQuote`](https://developer.adobe.com/commerce/webapi/graphql/schema/b2b/negotiable-quote/queries/quote/) and [`negotiableQuotes`](https://developer.adobe.com/commerce/webapi/graphql/schema/b2b/negotiable-quote/queries/quotes/) queries. <!-- PWA-1292-->
