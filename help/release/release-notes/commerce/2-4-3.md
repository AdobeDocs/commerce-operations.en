...
*  [Amazon Pay](https://commercemarketplace.adobe.com//amzn-amazon-pay-magento-2-module.html). Amazon Pay has been deprecated and will be removed in a later 2.4.x release. Version 2.4.3 and higher will contain only updates for compatibility and fixes for major bugs.
