...
*   Zend framework (ZF1) components that have reached end of life have been removed from the codebase. See [Backward-incompatible changes highlights](https://developer.adobe.com/commerce/php/development/backward-incompatible-changes/).<!-- AC-1512 -->
...
*   **Improved import performance (up to 100,000 records per minute)**. Merchants can use the new `POST /rest/<store_view_code>/V1/import/csv` REST API endpoint to import data into Adobe Commerce. This endpoint provides the same capabilities as the Admin import feature and supports using a CSV file to create, update, and remove products, product pricing, and customer entities. See [Import data](https://developer.adobe.com/commerce/webapi/rest/modules/import/). <!-- ACPT-6 -->
