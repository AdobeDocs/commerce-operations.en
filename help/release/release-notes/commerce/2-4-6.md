...
*  Purchase Order GraphQL schema covers B2B company user Purchase Order Management functionality such as creating, editing, and deleting purchase orders. See [Purchase orders (B2B)](https://developer.adobe.com/commerce/webapi/graphql/schema/b2b/purchase-order/).
*  Purchase Order Rule GraphQL schema provides the ability to create, edit, and delete approval rules as well as to manually validate purchase orders. See [Purchase order approval rules (B2B)](https://developer.adobe.com/commerce/webapi/graphql/schema/b2b/purchase-order-rule/).
