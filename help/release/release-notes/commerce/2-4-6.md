...
We are fixing hundreds of issues in the Adobe Commerce 2.4.6 core code. A subset of the fixed issues included in Adobe Commerce 2.4.6 is described below.
...
*  Merchants now have the ability to customize a custom external SMTP provider. [GitHub-26104](https://github.com/magento/magento2/issues/26104)
...
*  GraphQL queries that return information about purchase orders now generate masked quote IDs as expected. 
