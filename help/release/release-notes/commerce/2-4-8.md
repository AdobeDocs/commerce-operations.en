    ...
    <tbody>
        <tr>
            ...
            <td>This release includes the following enhancements to security settings:
              <ul>
                <li><strong>Duo Security 2FA</strong>: This change updates the <a href="https://experienceleague.adobe.com/en/docs/commerce-admin/systems/security/tfa/security-two-factor-authentication-use#duo-security">Duo Security</a> two-factor authentication (2FA) implementation in Adobe Commerce to use the latest SDK (Web SDK v4). This upgrade enables merchants to transition seamlessly to using Duo Universal Prompt. Merchants must update their configuration in the Admin settings to include a Client ID and Secret.<!-- AC-10982 --></li>
...
<table style="table-layout:auto">
    <tbody>
        ...
        <td>
            <ul>
                <li><!--LYNX-387-->Added the following new fields to the <a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-c-e#cartitemprices"><code>CartItemPrices</code></a> type to support accurate pricing display and discount calculations:
                <ul>
              ...
              <li><!--LYNX-542-->Updated the <a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/mutations#updatecartitems"><code>updateCartItems</code></a> mutation to return success responses with error details instead of exceptions. Enhanced error mapping to improve the clarity of user notifications.</li>
              ...
              <li><!--LYNX-451-->Added the <code>grand_total_excluding_tax</code> field to the <a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-c-e#cartprices"><code>CartPrices</code></a> type, providing clear tax-inclusive pricing.</li>
              <li><!--LYNX-377-->Added the <code>not_available_message</code> to the <a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-c-e#cartiteminterface"><code>CartItemInterface</code></a>.</li>
            </ul>
        </td>
       </tr>
        <tr>
           ...
           <td>This release includes the following customer management enhancements:
             <ul>
               <li><!--LYNX-391-->Refined error handling in the <a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/mutations#generatecustomertoken"><code>generateCustomerToken</code></a> mutation to provide specific messages for unconfirmed emails. Supports better user guidance and error resolution.</li>
        ...
        <tr>
           ...
           <td>This release includes the following user order management enhancements:
             <ul>
              ...
              <li><!--LYNX-470-->Added a new <code>date_of_first_order</code> field to the <a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-c-e#customerorders"><code>CustomerOrders</code></a> type.</li>
              <li><!--LYNX-468-->Extended the <a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-k-p#orderaddress"><code>OrderAddress</code></a> type to include custom attributes, enhancing order detail visibility. Supports additional information display on order confirmation pages.</li>
              <li><!--LYNX-450-->Added the <code>is_virtual</code> field to the <a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-c-e#customerorder"><code>CustomerOrder</code></a> type, supporting virtual product identification. Enhances order processing by distinguishing virtual from physical products.</li>
              <li><!--LYNX-449-->Added an <code>OrderItemPrices</code> type similar to <a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-c-e#cartitemprices"><code>CartItemPrices</code></a> to <a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-k-p#orderiteminterface"><code>OrderItemInterface</code></a> with several new fields for price.</li>
              ...
              <li><!-- LYNX-523: -->Extended the <a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-c-e#customerorder"><code>CustomerOrder</code></a> type to include an <code>available_actions</code> field for better order management. The `available_actions` field maps to an enumeration that lists the possible actions that can be performed on the order.</li>
              <li><!-- LYNX-524 -->Added the <code>customer_info</code> field to the <a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-c-e#customerorder"><code>CustomerOrder</code></a> type. This field requires the <code>OrderCustomerInfo</code> type, which contains details about the customer name.</li>
              <li><!--LYNX-519-->Added detailed error codes to the <a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-c-e#cancelorderoutput"><code>CancelOrderOutput</code></a> type. Improved error handling and user feedback for the order cancellation processes.</li>
              ...
              <li><!--LYNX-470-->Added an order history filter based on the <code>created_at</code> field and exposed <code>date_of_first_order</code> with the <a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-c-e#customerorders"><code>CustomerOrders</code></a> type.</li>
              <li><!--LYNX-450-->Added the <code>is_virtual</code> field to the <a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-c-e#customerorder"><code>CustomerOrder</code></a> type, similar to the <a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-c-e#cart"><code>Cart</code></a> type. This allows the customer to conditionally hide shipping information for orders containing only virtual products.</li>
        ...
        <td>
            <ul>
              <li><!--LYNX-540-->Added a <code>quantity</code> field in the <a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-k-p#productinterface"><code>ProductInterface</code></a> to provide stock level details. It displays available stock or null based on Admin settings.</li>
              <li><!--LYNX-460-->Corrected pricing display for bundle products, ensuring accurate price and currency information.</li>
              <li><!--LYNX-401-->Added the <code>grouped_product_image</code> and <code>configurable_product_image</code> fields to the <a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-q-s#storeconfig"><code>StoreConfig</code></a> type.</li>
            </ul>
        </td>
    </tr>
    <tr>
        ...
        <td>
            <ul>
              <li><!--LYNX-713-->Updated the <a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-f-i#giftoptionsprices"><code>GiftOptionsPrices</code></a> and <a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-k-p#ordertotal"><code>OrderTotal</code></a> types to include both <code>price_excluding_tax</code> and <code>price_including_tax</code> fields for gift wrapping (per item and order) and printed cards. This enhancement ensures accurate tax display based on store configuration settings for both cart and order queries.</li>
              ...
              <li><!--LYNX-693-->Added <code>gift_message</code> and <code>gift_wrapping</code> fields to the <a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-f-i#giftcarditem"><code>GiftCardCartItem</code></a> type; updated logic to discard gift wrapping for virtual products.</li>
    ...
    <tr>
        ...
        <td>
            <ul>
                <li><!--LYNX-632-->Updated the <a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/mutations#requestreturn"><code>requestReturn</code></a> mutation for RMA items input to resolve inconsistencies between the return attribute related query and mutation.</li>
                <li><!--LYNX-515-->Updated the <a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/mutations#requestreturn"><code>requestReturn</code></a> mutation to support guest order returns.</li>
            </ul>
        </td>
    </tr>
    <tr>
        ...
        <td>
            <ul>
                <li><!--LYNX-633-->Updated the <a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-q-s#storeconfig"><code>StoreConfig</code></a> type with fields to match the tax display settings in the Admin configuration.</li>
                <li><!--LYNX-697-->Added the <code>subtotal_excl_tax</code> and <code>subtotal_incl_tax</code> fields to the <a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-k-p#ordertotal"><code>OrderTotal</code></a> type. Marked the <code>subtotal</code> field as deprecated.</li>
            </ul>
        </td>
    </tr>
    <tr>
        ...
        <td>
            <ul>
                <li><!--LYNX-618-->Added an identifier for the address book in shipping or billing cart address in the <a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-c-e#cartaddressinterface"><code>CartAddressInterface</code></a> type.</li>
                <li><!--LYNX-617-->Added the <code>same_as_billing</code> field to the <a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-q-s#shippingcartaddress"><code>ShippingCartAddress</code></a> type, which indicates whether the shipping and billing addresses are the same.</li>
                <li><!--LYNX-458-->Updated the <a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/#guestorder"><code>guestOrder</code></a> and <a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/#guestorderbytoken"><code>guestOrderByToken</code></a> queries to include custom address attributes, ensuring complete address information for new accounts.</li>
            </ul>
        </td>
    </tr>
    <tr>
        ...
        <td>
            <ul>
                <li><!--LYNX-522-->Added a <code>theme</code> field to the <a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/#recaptchav3config"><code>recaptchaV3Config</code></a> query. This field allows you to specify the name of the theme to use to render the reCaptcha ensuring accurate price and currency information.</li>
