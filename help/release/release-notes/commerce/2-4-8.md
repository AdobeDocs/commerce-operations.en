    ...
    <tbody>
        ...
        <td>
            <ul>
              ...
              <li><!--LYNX-542-->Updated the <a href="https://developer.adobe.com/commerce/webapi/graphql/schema/cart/mutations/update-items"><code>updateCartItems</code></a> mutation to return success responses with error details instead of exceptions. Enhanced error mapping to improve the clarity of user notifications.</li>
              ...
              <li><!--LYNX-377-->Added the <code>not_available_message</code> to the <a href="https://developer.adobe.com/commerce/webapi/graphql/schema/cart/interfaces/"><code>CartItemInterface</code></a>.</li>
            </ul>
        </td>
       </tr>
        <tr>
           ...
           <td>This release includes the following customer management enhancements:
             <ul>
               <li><!--LYNX-391-->Refined error handling in the <a href="https://developer.adobe.com/commerce/webapi/graphql/schema/customer/mutations/generate-token"><code>generateCustomerToken</code></a> mutation to provide specific messages for unconfirmed emails. Supports better user guidance and error resolution.</li>
    ...
    <tr>
        ...
        <td>
            <ul>
                ...
                <li><!--LYNX-458-->Updated the <a href="https://developer.adobe.com/commerce/webapi/graphql/schema/orders/queries/guest-order"><code>guestOrder</code></a> and <a href="https://developer.adobe.com/commerce/webapi/graphql/schema/orders/queries/guest-order-by-token"><code>guestOrderByToken</code></a> queries to include custom address attributes, ensuring complete address information for new accounts.</li>
            </ul>
        </td>
    </tr>
    <tr>
