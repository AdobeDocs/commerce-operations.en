...
<table style="table-layout:auto">
    <tbody>
        ...
        <tr>
            <td><strong>Data collector</strong>
            <td>The [!UICONTROL System] > [!UICONTROL Support] > [!UICONTROL Data Collector] has been removed to prevent unauthorized access and enhance platform security.</td>
        </tr>
    </tbody>
</table>
