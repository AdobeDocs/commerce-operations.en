...
Adobe Commerce 2.4.8 brings enhanced security, compatibility with PHP 8.4 and MariaDB 11.4, extensive GraphQL API improvements to accelerate migration to a new [Adobe Commerce Storefront](https://experienceleague.adobe.com/developer/commerce/storefront/) powered by Edge Delivery Services, and over 500 quality fixes and enhancements to elevate existing functionality. Upgrading to 2.4.8 keeps your platform secure, aligned with the latest technological advancements, and supported through April 2028.

>[!BEGINSHADEBOX]

**Adoption recommendations**

The timing of your upgrade to Adobe Commerce 2.4.8 should consider business priorities, your current version, and plans to adopt new [Adobe Commerce as a Cloud Service](https://experienceleague.adobe.com/en/docs/commerce/cloud-service/overview) or [Adobe Commerce Optimizer](https://experienceleague.adobe.com/en/docs/commerce/optimizer/overview) products.

* **Customers planning to adopt Adobe Commerce as a Cloud Service or Adobe Commerce Optimizer in the next 12-16 months**: Deploy the latest security patch now and upgrade to the latest Adobe Commerce version when you adopt the new products. This allows you to avoid upgrading twice in a short period of time.

* **Customers NOT planning to adopt Adobe Commerce as a Cloud Service or Adobe Commerce Optimizer in the next 12-16 months**:

  * **Customers on versions 2.4.4, 2.4.5 or 2.4.6**: Start your upgrade to Adobe Commerce 2.4.8 soon, as support for 2.4.4 ends in April 2026 and 2.4.5 and 2.4.6 ends in August 2026.

  * **Customers on version 2.4.7**: While we encourage you to upgrade as soon as possible to benefit from product enhancements, you have more flexibility to choose a time that aligns with business priorities. Your version will continue to be supported until April 2027.
...
<table style="table-layout:auto">
    <tbody>
        ...
        <tr>
           ...
           <td>This release includes the following customer management enhancements:
             <ul>
               ...
               <li><!--LYNX-773-->Added a new <a href="https://developer.adobe.com/commerce/webapi/graphql/schema/customer/queries/segments/"><code>customerSegments</code></a> query to enable personalization capabilities.</li>
               <li><!--LYNX-729-->Added the <code>customerGroup</code> query to return customer group-related information for guests and customers.</li>
               <li><!--LYNX-732-->Added new store configurations for managing customer groups, introduced the <a href="https://developer.adobe.com/commerce/webapi/graphql/schema/customer/queries/all-groups/"><code>allCustomerGroups</code></a> query to retrieve a list of all available customer groups, and exposed the <code>Customer.group</code> field to access the currently logged-in customer's group information.</li>
        ...
        <td>
            <ul>
              <li><!--LYNX-730-->Added store configurations for catalog pricing rules, added the <a href="https://developer.adobe.com/commerce/webapi/graphql/schema/products/queries/all-rules/"><code>allCatalogRules</code></a> query to retrieve all available catalog rules, and exposed the <code>Product.rules</code> field to show catalog rules currently applied to a product.</li>
