    ...
    <tbody>
        ...
        <td>
            <ul>
              ...
              <li><!--LYNX-753-->Added support for retrieving terms and conditions configuration settings via the <code>StoreConfig</code> GraphQL query. New Configurations available: [!UICONTROL Stores] > [!UICONTROL Settings] > [!UICONTROL Configuration] > [!UICONTROL Checkout] > [!UICONTROL Checkout Options] > [!UICONTROL Enable Terms and Conditions]. These settings enable frontend applications to dynamically enable and configure terms and conditions by store view in checkout page.</li>
