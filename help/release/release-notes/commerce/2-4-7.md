...
*   **Faster save operations of store-level configurations for deployments with many stores**. Saving configuration settings in deployments with more than 500 stores can be time-consuming. The new [Async Config](../../../performance-best-practices/configuration.html?lang=en#asynchronous-configuration-save-2.4.7-beta1) module enables asynchronous configuration save operations by running a cron job that uses a consumer to process the save operation in a message queue. AsyncConfig is disabled by default.
...
See [Application Server for GraphQL APIs](../../../performance-best-practices/performance-best-practices/application-server.html) for both on-premises and Cloud deployments.
...
You can install Adobe Commerce 2.4.7-beta2 using [Composer](../../../installation-guide/composer.html).
