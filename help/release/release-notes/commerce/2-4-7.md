...
**New security enhancement for 2.4.7-beta3**
...
Commerce 2.4.7-beta3 introduces tyhe following enhancements to Commerce performanc and sclability: 
...
* **Product listing page for complex products with many options**. Load time has improved for product listing pages that include complex products with over 100 options. The performance of GraphQL requests to list products by category has improved, too. <!-- ACPT-1683 -->
