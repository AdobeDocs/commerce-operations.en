...
**Issue**: A product is not removed as expected from the mini cart after the shared catalog that is assigned to it has been removed from the product. This issue was a known issue for 2.4.7-beta1 and is scheduled for resoltuion in 2.4.7-beta3. <!-- AC-8935 -->
