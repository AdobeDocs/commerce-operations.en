...
*  The `GetCartDetails` query no longer returns an error when a product in the specified cart is out of stock. Previously, shoppers using this query to make a purchase could not complete their purchase when an item was out of stock, and their checkout page was blank.
...
*  The **[!UICONTROL My billing and shipping address are the same]** checkbox now remains checked by default when a shopper uses Chrome autocomplete to fill in their shipping address and then clicks **[!UICONTROL Next]** before the shipping methods block is reloaded. [GitHub-33725](https://github.com/magento/magento2/issues/33725)
...
*  The category page now re-loads with the correct pagination after you open the page, change the pagination, navigate to a product page, and then return to the category page.  [GitHub-36563](https://github.com/magento/magento2/issues/36563)
