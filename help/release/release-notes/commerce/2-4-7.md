...
* Caching for custom customer attributes has been expanded to include these queries:

   `attributesList` <!-- LYNX-150 -->
   `attributeForms` <!-- LYNX-151 -->
   `AttributesList` <!-- LYNX-149 -->
...
* GraphQL support for order cancelation. The `cancelOrder` mutation allows a customer to cancel an order, passing its identifier and a cancellation reason. <!-- LYNX-197 -->
...
`cancelOrder` (2.4.7-beta2) <!-- LYNX-172 --> 
