...
* Shoppers can now log in to their store account and [vault Braintree payment information](https://experienceleague.adobe.com/en/docs/commerce-admin/stores-sales/payments/braintree#step-3-complete-the-advanced-settings) from their Accounts page for ease of later payment. <!-- BUNDLE-3328 -->
