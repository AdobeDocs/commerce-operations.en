...
* This release introduces two significant changes to non-generated cache keys:
...
* Commerce now limits the number of coupon codes that are automatically generated. The default maximum is xxx. Merchants can use the new Code Quantity Limit configuration option (Stores > Settings:Configuration > Customers > Promotions)  to prevent potentially overwhelming the system with many coupons. !-- AC-8753 -->

* The generation of the default Admin URL has been optimized for increased randomness, which makes generated URLs less predictable. <!— AC-9028 -->
...
The following platform components were upgraded to their latest versions for 2.4.7-beta3:
...
**Platform enhancements introduced in 2.4.7-beta2**
