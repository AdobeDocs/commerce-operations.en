...
Adobe Commerce 2.4.7-beta3 introduces support for PHP 8. It includes over 200 quality fixes and enhancements. Core Composer dependencies and third-party libraries have been upgraded to the latest available versions.
...
Adobe Commerce 2.4.7-beta3 introduces six security fixes and platform security improvements. Previous betas of Adobe Commerce 2.4.7 introduced 13 security fixes and platform security improvements.
...
**New security enhancements for 2.4.7-beta3**

This release introduces three significant security enhancements:
...
**Security enhancements introduced in previous 2.4.7-beta releases**
...
Adobe Commerce 2.4.7-beta3 introduces the following platform upgrades:

**PHP 8.3 compatibility**. This release introduces support for PHP 8.3. Adobe Commerce 2.4.7-beta3. Commerce now supports both PHP 8.3 and 8.2. PHP 8.2 will be supported until its End of Service (EOS) date in December 2025. After December 2025, all merchants running 2.4.7 deployments must migrate to PHP 8.3. <!-- AC-8988 -->

Adobe Commerce 2.4.7-beta3 is still compatible with PHP 8.1 for upgrade purposes only. PHP 8.1 is not supported and not recommended. 

**Other platform enhancements for 2.4.7-beta3**

* Composer 2.5.x. compatibility with Composer 2.2.x remains. <!-- AC-9663 -->

* **Varnish cache 7.4 support**. This release is compatible with the latest version of Varnish Cache 7.34. Compatibility remains with the 6.0.x and 7.2.x versions, but we recommended using Adobe Commerce 2.4.7-beta3 only with Varnish Cache version 7.4 or version 6.0 LTS. <!-- AC-9662 -->

* **RabbitMQ 3.13 support**. This release is compatible with the latest version of RabbitMQ 3.13. Compatibility remains with RabbitMQ 3.9, which is supported through August 2023, but we recommended using Adobe Commerce 2.4.7-beta3 only with RabbitMQ 3.11. <!-- AC-9658 -->
...
* `utf8mb3` coalition has been upgraded to `utf8mb4`. (`utf8mb3` coalition has been deprecated in MySQL 8.) <!-- AC-8828 -->

* latest patch versions of MariaDB and MySQL

* The `jquery.jstree` library has replaced `extjs`. <!-- AC-9320 -->

* The `jquery/fileUpload` library has been removed as a dependency. <!-- AC-9154 --> 

The following platform components and Composer dependencies were upgraded to their latest versions for Commerce 2.4.7-beta3:

* `league/flysystem` <!-- AC-8089 -->
* `phpgt/dom` <!-- AC-8095 -->
* `imagemin-svgo` JavaScript library (v9.0.0) <!-- AC-8101 -->
* `jQuery/bootstrap` library (upgraded v5.1.3 to the v5.3.2) <!-- AC-8101 -->

**Platform enhancements introduced in previous betas**


The following platform components were upgraded to their latest versions for 2.4.7-beta2:
...
Commerce 2.4.7-beta3 introduces the following enhancements to Commerce performance and scalability: 

* Enterprise merchants can now configure up to **one million active, coupon-based cart price rules** in Adobe Commerce.  <!-- ACPT-1609 -->
...
* Deployments that include up to 100,000 active cart rules and one million active coupons. <!-- ACPT-1198 -->

**Performance enhancements introduced in previous beta releases**

Commerce 2.4.7-beta2 introduced:
...
Commerce 2.4.7-beta1 introduced: 
...
The Bolt checkout extension, which was included in Commerce 2.4.7-beta1, was removed in Adobe Commerce 2.4.7-beta2.
...
**B2B enhancements introduced in previous beta releases**
...
* GraphQL support has been added for order cancelation. The `cancelOrder` mutation allows a customer to cancel an order, passing its identifier and a cancelation reason. <!-- LYNX-197 -->
...
* The Braintree PHP and JavaScript SDKs have been updated to the latest versions.

* GraphQL support has been added for core operations for all payment methods with the exception of Venmo. <!-- BUNDLE-3326 -->
...
**Payment enhancements introduced in previous beta releases**

Commerce 2.4.7-beta2 introduced support for vaulted payments for these payment methods:
...
* Product alert emails are now triggered as expected when a product stock becomes available.  Previously, these emails were not sent because the execute method passed a `string` value instead an `int` as the `Magento\ProductAlert\Model\Mailing\ErrorEmailSender::execute()` method's `storeId` parameter. [GitHub-35602](https://github.com/magento/magento2/issues/35602)
...
<!-- AC-8369 8368 8365 8317 -->

* The forbidden `@author` tag has been removed from \ the code base. (Including these module:  `Magento_user-variable-wee`, Magento_Catalog, and Magento_Customer ). [GitHub-37245](https://github.com/magento/magento2/issues/37245), [GitHub-37246](https://github.com/magento/magento2/issues/37246), [GitHub-37249](https://github.com/magento/magento2/issues/37249), [GitHub-37263](https://github.com/magento/magento2/issues/37263)
...
* The sales order export CSV file now contains the properly formatted names of groups in the Customer Group column. Previously, no space was included between the label (**Customer Group**) and the group value.
...
* Merchants can now use Braintree PayPal without first enabling Braintree Credit Card. Previously, when a shopper selected the BrainTree PayPal payment method in the checkout workflow in deployments where Braintree Credit Card was not enabled, the payment method was not selected, and the page loader hung. Also, Adobe Commerce displayed this console error: `adapter.js:66 Uncaught TypeError: Cannot read properties of undefined (reading 'clientToken')`. [GitHub-35698](https://github.com/magento/magento2/issues/35698)
