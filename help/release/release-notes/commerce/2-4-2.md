...
*  Added support for multiple wishlists. You can use GraphQL to [create](https://developer.adobe.com/commerce/webapi/graphql/mutations/create-wishlist.html), [delete](https://developer.adobe.com/commerce/webapi/graphql/mutations/delete-wishlist.html), and [rename](https://developer.adobe.com/commerce/webapi/graphql/mutations/update-wishlist.html) wishlists as well as [move](https://developer.adobe.com/commerce/webapi/graphql/mutations/move-products-between-wishlists.html) or [copy](https://developer.adobe.com/commerce/webapi/graphql/mutations/copy-products-between-wishlists.html) items between them. <!-- MC-32356-->

*  Added support for returned merchandise authorizations (RMA). Shoppers can [request a return](https://developer.adobe.com/commerce/webapi/graphql/mutations/request-return.html). If the merchant accepts the request, the shopper can perform tasks such as [adding a comment](https://developer.adobe.com/commerce/webapi/graphql/mutations/add-return-comment.html) and [add tracking information](https://developer.adobe.com/commerce/webapi/graphql/mutations/add-return-tracking.html). <!-- MC-34596-->

*  Added support for the following B2B features:
   *  Companies. You can add company [administrators](https://developer.adobe.com/commerce/webapi/graphql/mutations/create-company.html), [users](https://developer.adobe.com/commerce/webapi/graphql/mutations/create-company-user.html), [roles](https://developer.adobe.com/commerce/webapi/graphql/mutations/create-company-role.html), and [teams](https://developer.adobe.com/commerce/webapi/graphql/mutations/create-company-team.html). <!-- MC-33861-->
   *  Company credit. The [company query](https://developer.adobe.com/commerce/webapi/graphql/queries/company.html) includes details about the company's credit history. <!-- MC-33862-->
   *  Requisition lists. You can [create](https://developer.adobe.com/commerce/webapi/graphql/mutations/create-requisition-list.html), [delete](https://developer.adobe.com/commerce/webapi/graphql/mutations/delete-requisition-list.html), and [update](https://developer.adobe.com/commerce/webapi/graphql/mutations/update-requisition-list.html) requisition lists. Support also includes the ability to [add](https://developer.adobe.com/commerce/webapi/graphql/mutations/add-products-to-requisition-list.html), [update](https://developer.adobe.com/commerce/webapi/graphql/mutations/update-products-in-wishlist.html), [delete](https://developer.adobe.com/commerce/webapi/graphql/mutations/delete-requisition-list-items.html), [copy](https://developer.adobe.com/commerce/webapi/graphql/mutations/copy-items-between-requisition-lists.html), and [move](https://developer.adobe.com/commerce/webapi/graphql/mutations/move-items-between-requisition-lists.html) items within a requisition list as well as add requisition list items [into the cart](https://developer.adobe.com/commerce/webapi/graphql/mutations/add-requisition-list-items-to-cart.html). <!-- MC-34312-->

*  Added support for unions in GraphQL. [GitHub-29425](https://github.com/magento/magento2/issues/29425) <!-- ENGCOM-8291 -->

*  Added support for [comparison lists](https://developer.adobe.com/commerce/webapi/graphql/queries/compare-list.html). Shoppers can [create](https://developer.adobe.com/commerce/webapi/graphql/mutations/create-compare-list.html) and [delete](https://developer.adobe.com/commerce/webapi/graphql/mutations/delete-compare-list.html) comparison lists, and [add](https://developer.adobe.com/commerce/webapi/graphql/mutations/add-products-to-compare-list.html) and [remove](https://developer.adobe.com/commerce/webapi/graphql/mutations/remove-products-from-compare-list.html) items to the comparison lists. In addition, shoppers that create a compare list as a guest can log in as a customer and [retain](https://developer.adobe.com/commerce/webapi/graphql/mutations/assign-compare-list-to-customer.html) their comparison lists.

*  Added the [`generateCustomerTokenAsAdmin`](https://developer.adobe.com/commerce/webapi/graphql/mutations/generate-customer-token-as-admin.html) mutation and updated the `Customer` object to support remote purchasing assistance.
...
*  Added the `staging` attribute to the [`ProductInterface`](https://developer.adobe.com/commerce/webapi/graphql/interfaces/product-interface.html) and [`CategoryInterface`](https://developer.adobe.com/commerce/webapi/graphql/interfaces/category-interface.html) to determine if a product is staged and to view its associated campaign information. <!-- MC-33897-->
...
*  [Amazon Pay](https://marketplace.magento.com/amzn-amazon-pay-magento-2-module.html). Amazon Pay has been deprecated in this release and will be removed in Magento 2.5.0. Version 2.4.3 and higher will contain only updates for compatibility and fixes for major bugs.
...
*  The ability to configure an installation to use a split database has been deprecated in this release. See the [Deprecation of split database functionality in Adobe Commerce](https://community.magento.com/t5/Magento-DevBlog/Deprecation-of-Split-Database-in-Magento-Commerce/ba-p/465187) DevBlog post.
