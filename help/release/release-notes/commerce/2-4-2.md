...
description: Learn about new features, enhancements, bug fixes and known issues in the 2.4.2 Adobe Commerce release.
...
*  [**Elasticsearch 7.9.x is now supported**](../../../installation/system-requirements.md). Although we recommend running Elasticsearch 7.9.x, version 2.4.x remains compatible with Elasticsearch 7.4.x. <!-- MC-36867-->

*  2.4.2 has been tested with [Varnish 6.4](../../../installation/system-requirements.md). Version 2.4.x remains compatible with Varnish 6.x.

*  [**Redis 6.x is now supported**](../../../installation/system-requirements.md). Version 2.4.x remains compatible with Redis 5.x. <!-- MC-34853-->
...
The ability to configure an installation to use a split database has been deprecated in this release. Merchants who currently use split database should start planning to revert to or migrate to a single database or use an alternative approach. See [Revert from a split database to a single database](../../../configuration/storage/revert-split-database.md) for migration instructions.
...
*  Added support for multiple wishlists. You can use GraphQL to [create](https://developer.adobe.com/commerce/webapi/graphql/schema/wishlist/mutations/create/), [delete](https://developer.adobe.com/commerce/webapi/graphql/schema/wishlist/mutations/delete/), and [rename](https://developer.adobe.com/commerce/webapi/graphql/schema/wishlist/mutations/update/) wishlists as well as [move](https://developer.adobe.com/commerce/webapi/graphql/schema/wishlist/mutations/move-products/) or [copy](https://developer.adobe.com/commerce/webapi/graphql/schema/wishlist/mutations/copy-products/) items between them. <!-- MC-32356-->

*  Added support for returned merchandise authorizations (RMA). Shoppers can [request a return](https://developer.adobe.com/commerce/webapi/graphql/schema/orders/mutations/request-return/). If the merchant accepts the request, the shopper can perform tasks such as [adding a comment](https://developer.adobe.com/commerce/webapi/graphql/schema/orders/mutations/add-return-comment/) and [add tracking information](https://developer.adobe.com/commerce/webapi/graphql/schema/orders/mutations/add-return-tracking/). <!-- MC-34596-->

*  Added support for the following B2B features:
   *  Companies. You can add company [administrators](https://developer.adobe.com/commerce/webapi/graphql/schema/b2b/company/mutations/create/), [users](https://developer.adobe.com/commerce/webapi/graphql/schema/b2b/company/mutations/create-user/), [roles](https://developer.adobe.com/commerce/webapi/graphql/schema/b2b/company/mutations/create-role/), and [teams](https://developer.adobe.com/commerce/webapi/graphql/schema/b2b/company/mutations/create-team/). <!-- MC-33861-->
   *  Company credit. The [company query](https://developer.adobe.com/commerce/webapi/graphql/schema/b2b/company/queries/company/) includes details about the company's credit history. <!-- MC-33862-->
   *  Requisition lists. You can [create](https://developer.adobe.com/commerce/webapi/graphql/schema/b2b/requisition-list/mutations/create/), [delete](https://developer.adobe.com/commerce/webapi/graphql/schema/b2b/requisition-list/mutations/delete/), and [update](https://developer.adobe.com/commerce/webapi/graphql/schema/b2b/requisition-list/mutations/update/) requisition lists. Support also includes the ability to [add](https://developer.adobe.com/commerce/webapi/graphql/schema/b2b/requisition-list/mutations/add-products/), [update](https://developer.adobe.com/commerce/webapi/graphql/schema/wishlist/mutations/update-products/), [delete](https://developer.adobe.com/commerce/webapi/graphql/schema/b2b/requisition-list/mutations/delete-items/), [copy](https://developer.adobe.com/commerce/webapi/graphql/schema/b2b/requisition-list/mutations/copy-items/), and [move](https://developer.adobe.com/commerce/webapi/graphql/schema/b2b/requisition-list/mutations/move-items/) items within a requisition list as well as add requisition list items [into the cart](https://developer.adobe.com/commerce/webapi/graphql/schema/b2b/requisition-list/mutations/add-items-to-cart/). <!-- MC-34312-->

*  Added support for unions in GraphQL. [GitHub-29425](https://github.com/magento/magento2/issues/29425) <!-- ENGCOM-8291 -->

*  Added support for [comparison lists](https://developer.adobe.com/commerce/webapi/graphql/schema/products/queries/compare-list/). Shoppers can [create](https://developer.adobe.com/commerce/webapi/graphql/schema/products/mutations/create-compare-list/) and [delete](https://developer.adobe.com/commerce/webapi/graphql/schema/products/mutations/delete-compare-list/) comparison lists, and [add](https://developer.adobe.com/commerce/webapi/graphql/schema/products/mutations/add-products-to-compare-list/) and [remove](https://developer.adobe.com/commerce/webapi/graphql/schema/products/mutations/remove-from-compare-list/) items to the comparison lists. In addition, shoppers that create a compare list as a guest can log in as a customer and [retain](https://developer.adobe.com/commerce/webapi/graphql/schema/customer/mutations/assign-compare-list/) their comparison lists.

*  Added the [`generateCustomerTokenAsAdmin`](https://developer.adobe.com/commerce/webapi/graphql/schema/customer/mutations/generate-token-as-admin/) mutation and updated the `Customer` object to support remote purchasing assistance.
...
*  Added the `staging` attribute to the [`ProductInterface`](https://developer.adobe.com/commerce/webapi/graphql/schema/products/interfaces/attributes/) and [`CategoryInterface`](https://developer.adobe.com/commerce/webapi/graphql/schema/products/interfaces/category/) to determine if a product is staged and to view its associated campaign information. <!-- MC-33897-->
...
*  Page Builder no longer requires all content types to be placed within a row. The [Page Builder stage](https://experienceleague.adobe.com/en/docs/commerce-admin/page-builder/walkthrough/3-catalog-content#stage) is now initially blank and supports adding the following content types directly to the stage: Rows, Columns, Tabs, HTML Code, Blocks, Dynamic Blocks.

*  Predefined margins and paddings are no longer required for content types.

*  The new mobile [viewport switcher](https://experienceleague.adobe.com/en/docs/commerce-admin/page-builder/walkthrough/3-catalog-content#viewports) and viewport scope for form field values lets users and developers perform these actions:
...
Interactive In-Product Guidance provides merchants with usage tips and information from within the Admin on new feature announcements, walk-through guides, on-boarding information, and tool tips.  **Administrators must opt-in from the Admin to receive in-product guidance if this feature is not enabled**. See [Usage Data Collection](https://experienceleague.adobe.com/en/docs/commerce-admin/start/admin/admin) and [Admin Usage](https://experienceleague.adobe.com/en/docs/commerce-admin/config/advanced/admin#admin-usage).
...
**Web-optimized images in content**. Merchants can now use [web-optimized image rendition](https://experienceleague.adobe.com/en/docs/commerce-admin/content-design/wysiwyg/gallery/media-gallery-image-optimization) in content instead of high resolution images. The original image remains unmodified in the Media Gallery, and the image rendition is dynamically generated when the image is inserted in the content.
...
*  [Yotpo Product Reviews](https://commercemarketplace.adobe.com//yotpo-module-yotpo.html)
...
*  The ability to configure an installation to use a split database has been deprecated in this release.
...
*  Administrators whose permissions exclude `Magento_Catalog::edit_product_design` (Edit Product Design) can now create a new product by saving an existing product with a new name in the selected store view. Previously, the application displayed this error:  `Not allowed to edit the product's design attributes`. [GitHub-28106 ](https://github.com/magento/magento2/issues/28106)
...
*  The application no longer throws an error when you try to change `backend-frontname` using the `ssh` container after installing Adobe Commerce. [GitHub-26762](https://github.com/magento/magento2/issues/26762)
...
*  The application no longer lists a downloadable product in My Download Products tab after the downloadable product has been partially refunded. [GitHub-28388](https://github.com/magento/magento2/issues/28388)
...
*  Adobe Commerce has improved cache performance by eliminating the flushing of tags multiple times per indexer instance. [GitHub-29890](https://github.com/magento/magento2/issues/29890)
