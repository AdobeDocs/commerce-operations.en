...
*  [Amazon Pay](https://docs.magento.com/user-guide/payment/amazon-pay.html). Amazon Pay has been deprecated in this release and will be removed in Magento 2.5.0. Version 2.4.3 and higher will contain only updates for compatibility and fixes for major bugs.
