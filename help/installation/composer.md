...
1. Create a Composer project using a Commerce metapackage.
   ...
   >[!NOTE]
   >
   > If you use a Composer `[auth.json](https://experienceleague.adobe.com/en/docs/commerce-on-cloud/user-guide/develop/authentication-keys)` file or environment variable configured with your Commerce authentication keys, you are not prompted to enter authentication keys.
