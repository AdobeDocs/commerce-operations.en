...
Adobe Commerce on Cloud customers must keep platform dependencies on supported versions. See [Platform dependencies](../release/lifecycle-policy.md#platform-dependencies) in the lifecycle policy.
...
>
>If you run Adobe Commerce on Cloud, you must upgrade to a supported release or migrate to [!DNL Adobe Commerce as a Cloud Service] before the **June 1, 2028** [security requirements and deadlines](../release/security-enforcement-policy.md). See the [end of support dates](../release/lifecycle-policy.md#end-of-support-dates) table for full lifecycle dates.
>
