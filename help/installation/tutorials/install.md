...
|`--cleanup-database`|To drop database tables before installing the the application, specify this parameter without a value. Otherwise, the database is left intact.|No|
...
You have the option to install the application without creating the administrator user as shown in the following example.
