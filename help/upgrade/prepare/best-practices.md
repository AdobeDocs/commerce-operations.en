...
- **API Extensibility**. Use [GraphQL](https://developer.adobe.com/commerce/webapi/graphql/) to extend Web API layer by evolving the graph data model and executing lambda functions directly from the graph layer.
...
To help you plan and budget for upgrades, you should monitor our [release schedule](/help/release/schedule.md). Plan upgrade tasks within your team's backlog ahead of time. Aim to complete this work with GA.
...
- Review the [Upgrade plan checklist](/help/implementation-playbook/best-practices/maintenance/upgrade-checklist.md) for Adobe Commerce to help you plan for your upgrade.
...
- Review the [release notes](/help/release/release-notes/overview.md) to understand the scope and impact of the new version.
