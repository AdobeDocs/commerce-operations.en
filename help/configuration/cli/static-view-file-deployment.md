...
| `--jobs (-j)` | Enable parallel processing using the specified number of jobs. The default is 0 (do not run in parallel processes). Default value is **0**. {{php-process-control}} | No |
