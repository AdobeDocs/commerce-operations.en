...
| GraphQL Query Resolver Results [!BADGE 2.4.7-beta]{type=Informative url="/help/release/release-notes/commerce/2-4-7.md" tooltip="Available in 2.4.7-beta only"} | graphql_query_resolver_result | Results from resolvers in GraphQL queries for customer, CMS pages, CMS blocks, and product media gallery entities. Keep this cache enabled to improve GraphQL performance.                                                                                                                                                                                                                                          |
