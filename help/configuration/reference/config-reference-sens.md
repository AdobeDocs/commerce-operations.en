...
| API Login ID | `payment_nz/authorizenet_directpost/login` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> | ![Commerce-only]([enc] | | ![Sensitive](/help/assets/configuration/cloud-sens.png) |
