...
| Company Registration Email Recipient | `company/email/company_registration` | | | ![Sensitive](../../assets/configuration/cloud_sens.png) |
| Send Company Registration Email Copy To | `company/email/company_registration_copy` | | | ![Sensitive](../../assets/configuration/cloud_sens.png) |
...
| Send Company Status Change Email Copy To | `company/email/company_status_change_copy` | | | ![Sensitive](../../assets/configuration/cloud_sens.png) |
...
| Company Credit Change Email Sender | `company/email/company_credit_change` |  | | ![Sensitive](../../assets/configuration/cloud_sens.png) |
...
| Send Quote Email Copy To | `sales_email/quote/copy_to` | | | ![Sensitive](../../assets/configuration/cloud_sens.png) |
