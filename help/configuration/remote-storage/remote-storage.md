...
>[!INFO]
>
>The sync command only migrates files in the `pub/media` directory, _not_ the import/export files in the `var` directory. See [Scheduled Import/Export](https://docs.magento.com/user-guide/system/data-scheduled-import-export.html) in the _Commerce 2.4 User Guide_.
