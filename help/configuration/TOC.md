...
+ Cache {#cache}
    ...
    + Varnish {#varnish}
        ...
        + [Configure the web server](cache/config-varnish-server.md)
        ...
        + [Cache clearing with Varnish](cache/use-varnish-cache.md)
        + [Cache clearing with multiple Varnish instances](cache/use-multiple-varnish-cache.md)
