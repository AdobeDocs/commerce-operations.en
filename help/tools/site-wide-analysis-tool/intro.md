...
- **Recommendations** - Provides a [SWAT Health Index Score](swat-health-index.md) to track site health and lists recommendations based on best practices to address issues detected on your site:
  ...
  - For changes that require manual intervention such as a [code deployment](https://experienceleague.adobe.com/en/docs/commerce-on-cloud/user-guide/architecture/pro-develop-deploy-workflow#deployment-workflow), ask your system administrator or developers for help.
