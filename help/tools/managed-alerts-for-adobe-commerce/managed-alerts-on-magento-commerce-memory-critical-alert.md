...
1. **[!DNL Redis]**: If [!DNL Redis] is a top source of memory consumption, [submit a support ticket](https://experienceleague.adobe.com/en/docs/commerce-knowledge-base/kb/help-center-guide/magento-help-center-user-guide#support-case).
