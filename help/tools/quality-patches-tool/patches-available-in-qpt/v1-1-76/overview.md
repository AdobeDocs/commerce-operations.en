...
1. **[ACSD-69331](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-76/acsd-69331.md)**: Fixes an issue where content creators in the media gallery couldn't create folders with only the Create Folder permission.
