...
1. **[ACSD-69086](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-76/acsd-69086.md)**: Fixes the issue where the cron job fails to clear changelog tables, causing [!DNL Galera Cluster] crashes when handling large amounts of data.
...
1. **[ACSD-69319](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-76/acsd-69319.md)**: Fixes an issue where bundle product prices weren't indexed properly when child products had stock under custom sources.
...
1. **[ACSD-69203](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-76/acsd-69203.md)**: Fixes an issue where the **[!UICONTROL Products List]** widget returns incorrect results when multiple categories were listed in the category condition.
...
1. **[ACSD-69129](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-76/acsd-69129.md)**: Fixes an issue where deleting the default base website and using the secondary website as the default results in an error when attempting to update the tier price for the secondary website via the [!DNL REST] API.
1. **[ACSD-69203](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-76/acsd-69203.md)**: Fixes an issue where the **[!UICONTROL Products List]** widget returns incorrect results when multiple categories were listed in the category condition.
...
1. **[ACSD-69308](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-76/acsd-69308.md)**: Fixes an issue where catalog price rules didn't apply when `special_price` was set only at the website level (not at **[!UICONTROL All Store Views]**).
...
1. **[ACSD-69325](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-76/acsd-69325.md)**: Fixes an issue where modifying the SKU case causes the product to appear out of stock on the storefront.
1. **[ACSD-69331](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-76/acsd-69331.md)**: Fixes an issue where admin users with only the Create Folder permission in the media gallery couldn't create folders.
