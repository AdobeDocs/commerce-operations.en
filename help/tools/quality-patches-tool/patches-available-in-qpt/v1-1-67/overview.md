...
1. **[ACSD-66084](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-67/acsd-66084-row-total-incl-tax-returns-near-zero-residual-value-instead-of-00-for-fully-discounted-items-in-the-order-api-response.md)**: `row_total_incl_tax` returns near-zero residual value instead of 0.00 for fully discounted items in the order API response.
