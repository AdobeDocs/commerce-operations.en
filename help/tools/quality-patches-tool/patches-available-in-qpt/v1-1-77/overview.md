...
1. **ACSD-63687**: Incorrect prices are displayed due to Redis cache cleanup issues.
...
1. **ACSD-68892**: Inconsistent Fastly caching behavior for cacheable pages.
1. **ACSD-69016**: Special price isn't applied on websites with different time zones.
1. **ACSD-69020**: Configurable products appear in Page Builder carousels when child products match filters.
