...
1. **[ACP2E-4547](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-82/acp2e-4547.md)**: Fixes the issue where an admin user cannot use **[!UICONTROL Add Products by SKU]** in Admin to add products from the standard catalog to a negotiable quote for a company assigned to a customer group that is not linked to a shared catalog.
