...
1. **[ACP2E-4797](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-82/acp2e-4797.md)**: Fixes the issue where entering 4-byte Unicode characters in WYSIWYG editor or Page Builder content in the Admin is incorrectly blocked even when the database is configured to support utf8mb4.
