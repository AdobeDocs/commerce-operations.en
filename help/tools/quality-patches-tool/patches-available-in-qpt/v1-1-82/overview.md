...
1. **[ACP2E-4748](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-82/acp2e-4748.md)**: Fixes the issue where reward points expiration process slowly on stores with a large reward points history, causing delays in expiring reward points.
