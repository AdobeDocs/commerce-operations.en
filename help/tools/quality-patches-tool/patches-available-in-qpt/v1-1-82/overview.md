...
1. **[ACP2E-4870](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-82/acp2e-4870.md)**: Fixes the issue where product alerts email notifications ignore store view email settings.
