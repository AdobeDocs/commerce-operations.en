...
1. **[ACP2E-4613](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-78/acp2e-4613.md)**: Fixes the issue where large media directory structures caused slow gettree responses, leading to extended Media Gallery directory tree loading times.
