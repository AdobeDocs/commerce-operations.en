...
1. **[ACP2E-4431](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-78/acp2e-4431.md)**: Fixes the issue where Related Products matched by the target rules are deleted during the reindex process.
