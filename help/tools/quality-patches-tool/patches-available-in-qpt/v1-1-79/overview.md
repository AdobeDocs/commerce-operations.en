...
1. **[ACP2E-4110](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-79/acp2e-4110.md)**: Fixes the issue where bundle products with a special price displayed incorrect amounts on PDP and PLP in a non-default currency.
