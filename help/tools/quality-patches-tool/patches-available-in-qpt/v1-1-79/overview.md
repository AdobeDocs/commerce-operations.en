...
1. **[ACP2E-4706](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-79/acp2e-4706.md)**: Fixes the issue where products not enabled in the [!UICONTROL Admin] scope were skipped by the [!UICONTROL Target Rule] indexer.
