...
1. **[ACP2E-4475](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-79/acp2e-4475.md)**: Fixes the issue where the products listing page incorrectly filters and sorts out-of-stock bundle products by price when the "Display Out of Stock Products" option is enabled.
