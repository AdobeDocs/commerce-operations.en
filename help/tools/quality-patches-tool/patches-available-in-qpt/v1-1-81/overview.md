...
1. **[ACP2E-4401](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-81/acp2e-4401.md)**: Fixes the issue where the Scheduled Update Preview of the Home Page link with configurable products redirects to the maintenance page instead of displaying the product list.
