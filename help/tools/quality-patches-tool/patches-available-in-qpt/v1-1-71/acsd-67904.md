...
description: Apply the ACSD-67904 patch to fix the Adobe Commerce issue where the checkout failed for city names containing special characters like . , &, or parentheses. 
