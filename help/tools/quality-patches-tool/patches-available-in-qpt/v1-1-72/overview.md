...
1. **[ACSD-68118](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-72/acsd-68118.md)**: `customerCart` GraphQL query returns product attribute values that don't reflect the store header, causing inconsistent localization.
