...
1. **[ACSD-67518](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-72/acsd-67518.md)**: Advanced reporting generates duplicated header rows when the row count exceeds the batch size.
