...
1. **[ACSD-66807](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-72/acsd-66807.md)**: `report_viewed_product_index` table shows an incorrect count of product page views.
