...
1. **[ACSD-68636](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-74/acsd-68636.md)**: Fixed the issue where the store owner’s name doesn't display correctly in gift card email headers for invoices generated from another store.
