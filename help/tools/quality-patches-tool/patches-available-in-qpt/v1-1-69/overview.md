...
1. **[ACSD-66404](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-69/acsd-66404-cron-job-fails-to-clear-changelog-tables-due-to-galera-cluster-transaction-size-limits.md)**: Cron job fails to clear changelog tables due to [!DNL Galera Cluster] transaction size limits.
