...
1. **[ACSD-67347](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-69/acsd-67347-order-fails-with-lock-error-when-using-special-character-coupons-and-file-locking.md)**: Order fails with lock error when using special character coupons and file locking.
