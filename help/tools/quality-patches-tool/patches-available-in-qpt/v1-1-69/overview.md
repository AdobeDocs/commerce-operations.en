...
1. **ACP2E-3731**: Product exports with "Catalog, Search" visibility include records from other store views.
...
1. **ACSD-66404**: Cron job fails to clear changelog tables, crashing Galera Cluster.
