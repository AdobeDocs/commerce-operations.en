...
1. **[ACP2E-4808](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-80/acp2e-4808.md)**: Fixes the issue where the Weight attribute on the storefront product page displays only a raw numeric value in the "Additional Information" or "More Information" section without the configured unit of measurement (lbs or kgs).
