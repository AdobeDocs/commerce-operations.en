...
1. **ACP2E-4653**: Fixes the issue where the Cart Price Rule condition attribute scope for **[!UICONTROL Category (Parent Only)]** and **[!UICONTROL Category (Children Only)]** isn't exposed when retrieving or updating rules through the REST API.
