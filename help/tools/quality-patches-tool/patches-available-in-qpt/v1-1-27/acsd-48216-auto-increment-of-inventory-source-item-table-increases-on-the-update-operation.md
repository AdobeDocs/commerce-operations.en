...
The ACSD-48216 patch fixes the issue where *AUTO_INCREMENT* of the *inventory_source_item* table increases on the *UPDATE* operation. This patch is available when the [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.27 is installed. The patch ID is ACSD-48216. Please note that the issue is scheduled to be fixed in Adobe Commerce 2.4.7.
