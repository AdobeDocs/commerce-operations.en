...
The ACSD-49748 patch fixes the issue where the users are not able to send email invitations. This patch is available when the [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.29 is installed. The patch ID is ACSD-49748. Please note that the issue is scheduled to be fixed in Adobe Commerce 2.4.7.
