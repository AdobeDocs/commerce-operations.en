---
title: "ACSD-60631: GraphQL query returns an error when the same product is assigned to multiple configurable products"
...
The ACSD-60631 patch fixes the issue where a GraphQL query returns an error when the same product is assigned to multiple configurable products. This patch is available when the [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.51 is installed. The patch ID is ACSD-60631. Please note that this issue is scheduled to be fixed in Adobe Commerce 2.4.8.
