...
The MDVA-43348 patch fixes the issue where Gift Card GraphQL request shows an error if `gift_card_options` contain "uid". This patch is available when the [Quality Patches Tool (QPT)](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.12 is installed. The patch ID is MDVA-43348. Please note that the issue is scheduled to be fixed in Adobe Commerce 2.4.5.
