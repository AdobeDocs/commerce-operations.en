...
1. **[ACSD-68573](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-75/acsd-68573.md)**: Fixes the issue where category permissions weren't applied properly to customer wishlist items. After the fix, wishlist items are properly displayed and paginated in both the web and GraphQL.
