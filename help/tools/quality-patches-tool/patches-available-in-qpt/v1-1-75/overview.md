...
1. **[ACSD-68490](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-75/acsd-68490.md)**: Fixes the issue where the **[!UICONTROL Add New Attribute]** button is visible for a restricted admin user during configurable product creation.
