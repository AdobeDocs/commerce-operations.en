...
1. **[ACSD-68289](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-75/acsd-68289.md)**: Fixes an issue where full-text search now returns matching products if the minimum match condition is met across all searchable fields collectively, rather than requiring the condition to be satisfied by a single field.
