...
1. **[ACSD-66506](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-68/acsd-66506-backend-error-occurred-when-previously-assigned-products-of-a-shared-catalog-were-deleted-and-new-ones-assigned.md)**: Backend error occurred when previously assigned products of a Shared Catalog were deleted and new ones assigned.
