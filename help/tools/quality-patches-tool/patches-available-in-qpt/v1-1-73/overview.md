...
1. **[ACSD-68206](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-73/acsd-68206.md)**: Fixed the error when using the GraphQL Application server with the **[!UICONTROL Rate Limiting]** feature with PHP [!DNL Redis] extension installed.
