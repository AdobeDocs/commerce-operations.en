...
2. Create a cart price rule:
   ...
   - Actions: 
     ...
     - Applies only to cart items where SKU is `virtual2`.
3. Add products to a fresh, empty, quote through storefront:
   - Add `virtual1` SKU first.
   - Add `virtual2` SKU second.
4. Get cart details using the following [!DNL GraphQL] query:
...
5. Check **[!UICONTROL cart]** > **[!UICONTROL items]** > **[!UICONTROL prices]** > **[!UICONTROL discounts]**.
