...
1. **ACSD-66120**: GraphQL shows incorrect discount percentage and base price with tax-inclusive catalog pricing.
...
1. **ACSD-67289**: Regular price doesn't display when special price is applied.
