...
* **MDVA-33632** (*for Adobe Commerce `>=2.3.0 <2.3.7`*) - Provides a fix where the exception message "*his product is out of stock* is now displayed to admin user when trying to re-order an out of stock product.
