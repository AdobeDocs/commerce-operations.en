...
* **MDVA-44660** (*for Adobe Commerce and Magento Open Source `>=2.4.2-p1 <2.4.5`*) - Fixes the issue where the grave accent character \[&grave`\] could not be used for a customer's first and last name.
