...
* **ACSD-67908** (for Adobe Commerce and Magento Open Source >=2.4.4 <2.4.9) - Fixes the issue where files fail to merge properly in multi-store setups.
...
* **ACSD-68400** (for Adobe Commerce and Magento Open Source >=2.4.4 <2.4.8) - Fixes the issue where the quantity of a virtual gift card containing multiple items did not accurately reflect in the inventory reservation table.
