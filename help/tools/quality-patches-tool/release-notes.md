...
* **ACSD-52041** (for Adobe Commerce and Magento Open Source >=2.4.4 <2.4.7) - Fixes the issue where the error message: [ERROR] Page Builder was rendering for 5 seconds without releasing locks. in Chrome browser when saving content edited with Page Builder.
...
* **ACSD-51984** (for Adobe Commerce >=2.4.5 <2.4.7) - Fixes the issue where unchecked "Use Default Value" and non-default product field values are not saved for the second website, store, and store view.
